      ...
      <section className="py-24 px-6">
        <div className="mx-auto max-w-4xl">
          ...
          >
            ...
            >
              Bhagwan MahaVishnu took a special Avatar of Lord Rama long after
              the end of Rama Avatar to appear again on Earth to fulfil his
              promise to Rishi Bhadra. This divine manifestation is known as
              Vaikuntta Rama.
            </motion.p>
            ...
            >
              This unique form of Lord Rama is distinguished by having four
              hands, holding Shanku (conch) on the right, Chakra (discus) at his
              left, and Dhanurbhana (bow and arrow) in the other two hands, with
              Sita seated on his left lap and brother Laxmana standing at his
              left.
            </motion.p>
          </motion.div>
        </div>
        ...
        <div className="mx-auto max-w-6xl space-y-24">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <motion.div
                variants={fadeInUp}
                className="space-y-4 p-6 rounded-2xl bg-background"
              >
                <p className="text-muted-foreground leading-relaxed">
                  Bhadra performed penance at the bank of river Godavari in
                  &quot;Dandakaranya&quot; to receive the grace of Lord Rama.
                  The exalted Rishi implored Rama to be seated on his head, but
                  Lord Rama, who was in search of his consort Sita, gave promise
                  to his Bhakta that his desire would be fulfilled on his way
                  back after finding Sita and accomplishing the process of
                  punishing the wicked Ravana and establishing Dharma.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  by blowing Shanku, accompanied by his consort Sita and brother
                  Laxmana, resembling that of Gajendra Moksham.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              className="p-8 rounded-2xl bg-background space-y-4"
            >
              <p className="text-muted-foreground leading-relaxed">
                The idols of VAIKUNTTA Rama, Laxmana and Sita were found by
                Pokala Dhammakka, an ardent devotee of Lord Rama who lived in
                the 17th century. She was an inhabitant of Bhadrireddypalem, a
                mile away from the holy place of Bhadrachalam.
              </p>

              <p className="text-muted-foreground leading-relaxed">
                On one fine night, she had darshan of Lord Rama in her dream who
                said, &quot;The saints and sages are worshiping my embodied
                moorthy settled on Bhadragiri&quot; and asked her to trace them,
                perform pooja and attain salvation. The very next morning, she
                started searching for the idols and peered into an ant-hill
                where she found the idols hidden.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Lord Rama told Dhammakka that at a later date, one of his
                devotees would construct a Mandir at this site. Dhammakka waited
                patiently for the devotee, who turned out to be Bhakta Ramadas.
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <motion.div
                variants={fadeInUp}
                className="space-y-4 p-6 rounded-2xl bg-background order-2 md:order-1"
              >
                <p className="text-muted-foreground leading-relaxed">
              ...
              <motion.div
                variants={fadeInUp}
                className="relative h-64 md:h-full rounded-2xl overflow-hidden order-1 md:order-2"
              >
                <Image
          ...
          >
            ...
            >
              <p className="text-muted-foreground leading-relaxed">
                ...
                funds and imprisoned for 12 long years in Golkonda Fort, where
                he endured much torture. Unable to withstand the miseries,
                Ramadas implored Rama to relieve him by singing many praising
                and emotional songs, which became popularized as Dasaradhi
                Sathakam and Keertanas.
              </p>

              <p className="text-muted-foreground leading-relaxed">
                The divine miracle occurred when Lord Rama and Laxmana
                themselves appeared before Nawab Tanishah as Ramoji and Laxmoji,
                claiming to be servants of Bhakta Ramadas. They repaid the 6
                lakh Mohurs to secure his release from imprisonment. They gave a
                voucher to Tanishah and placed it under Gopanna&apos;s pillow in
                jail.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                arranged for Gopanna&apos;s release and begged forgiveness,
                placing all the Gold Mohurs at Gopanna&apos;s feet. Ramadas
                refused to take back the mohurs except for two, as a mark of
                divine significance. These two mohurs can still be seen at the
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                temple&apos;s maintenance. He also began the tradition of
                offering Pearls (Mutyala Talambralu) during the Kalyana
                Mahotsavam (Sri Rama Navami) ceremony, a practice that continues
                to this day with the state government sending pearls during the
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                ...
                SEETHA RAMACHANDRA SWAMY VAARI DEVASTHANAM, we have taken the
                unique appearance of Lord Vishnu as VAIKUNTTA RAMA as the name
                for our Devalayammu in Shah Alam, Malaysia.
              </p>

              <p className="text-muted-foreground leading-relaxed">
                The Sri Vaikuntta Sitarama Devalayam continues this sacred
                tradition, bringing the blessings of Vaikuntta Rama to the
                devotees in Malaysia, particularly the Telugu community who
                migrated here over 150 years ago.
              </p>
            </motion.div>
          </motion.div>
        </div>
